...
async function continueOnMac(
  ...
  // Match the restored hard-handoff behavior from 2aea434: when Codex is already
  // open, relaunch it before opening the requested thread so the UI actually switches.
  if (!appRunning) {
    try {
